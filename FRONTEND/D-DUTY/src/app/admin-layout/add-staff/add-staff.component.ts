...
export class AddStaffComponent {
  constructor(private builder: FormBuilder, private adminService: AdminServiceService, private toast: ToastrService, private route: Router) { }
  regStaff=this.builder.group({
    id: this.builder.control('', Validators.required),
    name: this.builder.control('', Validators.required),
    password: this.builder.control('', Validators.required),
    email: this.builder.control('', Validators.compose([Validators.required,Validators.email])),
    deg: this.builder.control('', Validators.compose([Validators.required,Validators.maxLength(15)])),
